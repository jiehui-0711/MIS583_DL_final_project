...
def main(args):
    ...
    model = model.float()  # ★★★ 新增這行：在進入 GPU 前，強制把所有參數轉成 float32
    model.to(device)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if 'loss' in train_stats and 'loss' in test_stats:
